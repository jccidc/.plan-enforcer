...
for command in plan-enforcer plan-enforcer-abandon plan-enforcer-discuss plan-enforcer-awareness plan-enforcer-audit plan-enforcer-chain plan-enforcer-config plan-enforcer-doctor plan-enforcer-export plan-enforcer-import plan-enforcer-lint plan-enforcer-logs plan-enforcer-receipt plan-enforcer-report plan-enforcer-review plan-enforcer-phase-verify plan-enforcer-status plan-enforcer-verify plan-enforcer-why; do
